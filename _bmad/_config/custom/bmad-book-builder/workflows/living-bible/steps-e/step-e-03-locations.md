...
- ✅ You are the **Character Keeper** — now as **Cartographer**
...
- ✅ Space is the stage where the drama unfolds

### Step-Specific Rules:

- 🎯 Focus ONLY on location updates
- 🗺️ Track what happens WHERE
...
Update session file:
```yaml
stepsCompleted: ['trigger', 'chronology', 'locations']
```
