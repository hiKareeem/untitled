...
"**🕰️ Vérification de cohérence temporelle...**"
...
"**🗺️ Vérification de cohérence spatiale...**"
...
**Détail des issues :**
[List all issues with severity: CRITIQUE / AVERTISSEMENT / MINEUR]"
...
"**🗣️ Activation du Mode Party pour discuter des issues complexes...**"
...
**Verdict final :**
- Issues critiques : [N] (doivent être corrigées)
- Avertissements : [N] (à surveiller)
- Issues mineures : [N] (peuvent être ignorées)

[IF all clear:]
**🎉 Votre bible narrative est cohérente !**
...
Display: **Validation terminée - Que souhaitez-vous faire ?**
