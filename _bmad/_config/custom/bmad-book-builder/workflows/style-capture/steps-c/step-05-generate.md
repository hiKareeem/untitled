...
Use data from {anti_patterns} (step 04): Excessive Adverbs, Passive Voice, Clichés, Generic Dialogue, Slop Patterns. Use appropriate template for each category. Include Humanizer reference.
...
- Anti-Patterns: Adverb patterns, passive voice, clichés, dialogue issues, slop
