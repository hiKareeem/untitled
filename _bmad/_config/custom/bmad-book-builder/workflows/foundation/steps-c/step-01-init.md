...
- If exists AND all steps complete (stepsCompleted includes 7):
  - Ask user: "J'ai trouvé un plan de chapitres existant. Que souhaitez-vous faire ?
    1. Créer un nouveau plan (l'ancien sera archivé)
    2. Modifier le plan existant (mode édition)"
...
"Je remarque que vous n'avez pas encore de profil de style. Souhaitez-vous :
- **[S]** Lancer le workflow **style-capture** pour capturer votre voix d'écriture
- **[C]** Continuer sans — nous travaillerons avec votre style naturel"

**If character dossiers are missing:**

"Aucun dossier de personnages n'a été trouvé. Souhaitez-vous :
- **[P]** Lancer le workflow **build-characters** pour créer vos personnages
- **[C]** Continuer sans — nous découvrirons vos personnages pendant la fondation"

**If user selects S or P:**
- Note: "Ces workflows ne sont pas encore implémentés. Pour l'instant, nous continuerons sans."
...
"**Bienvenue dans le workflow Foundation !** 🏛️

Je suis votre Story Architect — ensemble, nous allons construire les fondations de votre histoire.

Comme un architecte dessine les plans avant de construire, nous allons :
1. **Découvrir** votre concept d'histoire
2. **Choisir** un cadre narratif adapté à votre vision
3. **Explorer** vos personnages, votre univers, et vos thèmes
4. **Construire** un plan de chapitres solide et actionnable

*Chaque grande histoire est construite avant d'être écrite.*

Êtes-vous prêt à poser la première pierre ?"
...
Votre projet est prêt. Passons maintenant à la découverte de votre histoire.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**Étape 2 sur 8 : Découverte de votre concept d'histoire**
```
