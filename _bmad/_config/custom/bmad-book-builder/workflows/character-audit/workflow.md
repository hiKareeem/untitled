...
"Bienvenue dans le workflow **Character Audit** ! Que souhaitez-vous faire ?

**[C]réer** — Créer un nouvel audit de personnage
**[M]odifier** — Modifier un audit existant
**[V]alider** — Valider la cohérence sans créer de fichier

Votre choix : [C]réer / [M]odifier / [V]alider"

### 3. Route to First Step

**IF mode == create:**

"**Création d'un audit de cohérence psychologique.**

L'audit vérifiera :
- Chaque contradiction du personnage
- La cohérence psychologique globale
- La progression de l'arc de transformation
...
"**Modification d'un audit existant.**"

Then load, read completely, and execute `./steps-e/step-01-load-audit.md`

**IF mode == validate:**

"**Validation sans création de fichier.**"
...
- Mark each as ✅ COHÉRENT or ❌ INCOHÉRENT
...
### Évaluation globale
- **Contradictions cohérentes:** X/5
- **Arc progression:** On track / Needs adjustment
- **Problèmes critiques:** 0, 1, 2+
```
