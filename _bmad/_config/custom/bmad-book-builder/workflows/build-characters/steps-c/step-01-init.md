...
**Profession/Statut :** _À déterminer_

**Origine sociale :** _À déterminer_
...
**[A] Collaborative — Questionnement guidé étape par étape**
...
**[B] Autonome — Je génère à partir de votre concept minimal**
...
**[C] Génération Libre — Je crée le personnage seule**
...
**[IF C] Single ou Multiple ?**
    **[S]** Un seul personnage
    **[M]** Liste diversifiée de personnages

### 5. Present MENU OPTIONS

Display: "**Select:** [A] Collaborative [B] Autonome [C] Génération Libre"
