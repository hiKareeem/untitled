...
"**Parfait!** Now let's explore where **{characterName}** came from.
...
Create/update a **Background** section in `{outputFile}` (add this before the Personnalité section):
