---
name: 'step-10a-complete'
description: 'Save character to story bible and complete workflow'
...
# Step 10a: Complete & Save to Bible (Collaborative)
...
**{characterName}** is complete. You've created a complex, authentic character with depth, contradictions, voice, and a compelling transformation arc.

This is significant work. Let me save them to the story bible for use in your stories."
...
"I notice [section] needs more attention. Would you like to:
- [1] Return to polish step to complete it
- [2] Proceed as-is (will mark section as 'À venir')"

Wait for author choice.

**IF all sections complete:**

"All sections are populated. Proceeding to save..."

### 3. Update Completion Metadata

Update `{outputFile}` frontmatter:

See template in `../../../data/templates/character-templates.yaml#frontmatter_complete_mode_a`
...
**Note:** The file should already exist from step-01-init. This step just updates the metadata.

### 5. Update Character Index

"**Now let me update the story bible character index...**"
...
- Completion metadata added to frontmatter
