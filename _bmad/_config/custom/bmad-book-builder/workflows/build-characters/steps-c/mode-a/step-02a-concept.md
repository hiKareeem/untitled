...
"**Parfait!** Let's explore who **{characterName}** is at their core.
...
"**Merci!** Here's what I understand about **{characterName}** so far:"
...
**Âge :** {age from responses}

**Profession/Statut :** {profession from responses}

**Origine sociale :** {social_origin from responses or "À déterminer"}
```
