...
> **🎯 NOUVEAU WORKFLOW — Gestion de recherche documentaire**
>
> Les romans crédibles demandent de la recherche. Les dossiers de recherche organisés permettent aux auteurs de vérifier les faits rapidement et maintiennent la cohérence.
>
> **Ce workflow centralise la recherche** pour qu'elle soit réutilisable à travers tout le projet.
