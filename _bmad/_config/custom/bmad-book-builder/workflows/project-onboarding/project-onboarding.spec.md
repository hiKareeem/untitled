...
> **🎯 PROBLÈME RÉSOLU**
>
> BBB est conçu pour des projets neufs, mais la plupart des auteurs ont déjà des projets en cours quand ils découvrent BBB.
>
> **Sans ce workflow :** L'auteur doit manuellement recréer sa Story Bible, migrer ses chapitres, etc.
>
> **Avec ce workflow :** BBB analyse le projet existant et propose une migration structurée et validée.

**Cas de test réel :** Projet AgentAdam dans `../../Writing/AgentAdam/` avec :
- 10 chapitres déjà écrits
- Annexes structurées (personnages, psychologie, architecture, thèmes)
- Documentation existante à convertir en format BBB
...
> **🎯 COMPLÉMENT AUTOMATIQUE — Étapes 7-8**
>
> Après la migration, le projet peut être incomplet par rapport aux standards BBB.
> Ces étapes détectent les manques et proposent de lancer les workflows nécessaires.
...
> **🎯 DÉCLENCHEMENT**
>
> Ce workflow est **manuel** — l'auteur choisit quand l'exécuter.
>
> **Point d'entrée typique :**
> - L'auteur découvre BBB avec un projet en cours
> - L'auteur veut migrer un projet existant vers BBB
> - Lancement via: `bmad run bmad-book-builder:project-onboarding`
>
> **Pas de déclenchement automatique** — C'est un workflow de migration one-time.
