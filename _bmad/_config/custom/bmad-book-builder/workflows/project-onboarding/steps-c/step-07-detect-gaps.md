...
**If migration incomplete:** "⚠️ Erreur : La migration n'est pas complète. Vérifiez l'étape 6."
...
```markdown
**✅ Validation terminée — Gaps détectés**

**Migration Status :** ✅ SUCCÈS

**Gaps détectés :**
- {gap_summary}

**Temps estimé pour compléter :** {total_time}
