...
If not approved: "⚠️ Erreur : Le plan de migration n'a pas été approuvé. Retournez à l'étape 5."
...
**Prêt pour détection des gaps BBB**
```
...
- ✅ Structure BBB créée
- ✅ {chapters} chapitres migrés avec frontmatter
- ✅ {characters} personnages convertis en YAML
- ✅ Contenu additionnel migré

**Vos fichiers originaux :** PRÉSERVÉS (mode hybride)

**Log d'exécution :** {executionLog}
