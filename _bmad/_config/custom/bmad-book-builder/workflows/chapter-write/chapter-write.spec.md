...
> **🎯 CONNEXIONS AUTOMATIQUES — Suite à l'analyse des interdépendances**
>
> Une fois le chapitre finalisé, ce workflow **déclenche automatiquement** les workflows de suivi pour garantir la cohérence du projet.
...
```
📝 Chapitre XX finalisé !

Workflows déclenchés automatiquement :
✅ Review — Valider la cohérence et la qualité (RECOMMANDÉ EN PREMIER)
✅ Bible-Update — Mettre à jour la bible narrative
✅ Character-Audit — Vérifier la cohérence des personnages (X personnages présents)
✅ Theme-Tracker — Suivre la progression thématique
✅ Rhythm-Analysis — Analyser le rythme et la tension

[C] Exécuter tous les workflows maintenant
[S] Sélectionner lesquels exécuter
[R] Review seulement — Puis les autres après corrections
[D] Différer — Je les exécuterai manuellement plus tard
```
