...
```html
<!--
📋 SYNOPSIS - Chapitre {chapter_number}
...
**Bible update needed:**
- Chronologie: {what_happened_when}
- Lieux: {any_location_changes}
- Objets: {objects_introduced_or_removed}
- Personnes: {character_state_updates}
- Thèmes: {thematic_progression}
