...
> **🎯 NOUVEAU WORKFLOW — Vérification de cohérence avec la réalité**
>
> Les histoires crédibles demandent une précision factuelle. Les erreurs techniques (métiers, procédures, outils) ou factuelles brisent l'immersion des lecteurs.
>
> **Exemple :** "Attention, on ne coupe pas un arbre avec un marteau" — type d'erreur que ce workflow doit détecter.
>
> **Capacités :** Web browsing pour validation, dossiers de recherche comme référence.
...
```markdown
## Reality Check Report — Chapitre 12
