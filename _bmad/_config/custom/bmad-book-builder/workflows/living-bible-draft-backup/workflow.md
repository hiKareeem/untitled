...
Je suis votre Character Keeper — le gardien de votre bible narrative vivante.

Ce workflow met à jour votre bible sur 5 dimensions :
1. **Chronologie** — Timeline jour par jour
2. **Lieux** — Inventaire des locations, ressources, événements
3. **Objets** — Inventaire des objets significatifs
4. **Personnages** — États psychologiques et relationnels actuels
5. **Thèmes** — Progression thématique par chapitre

Prêt à mettre à jour votre bible ?"
