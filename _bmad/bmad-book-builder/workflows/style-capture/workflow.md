...
- **anti-patterns:** Slop detection results (excessive adverbs, passive voice, cliche phrases, generic dialogue)
...
- **Web-Browsing** — Verify if words/phrases are cliches, compare with genre-specific patterns
