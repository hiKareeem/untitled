...
description: 'Detect anti-patterns: slop, cliches, excessive adverbs, passive voice, generic dialogue'
...
## STEP GOAL:
To detect and catalog anti-patterns (slop, cliches, excessive adverbs, passive voice, generic dialogue) in the collected writing samples, providing specific improvement suggestions.
...
### 4. Detect Cliche Phrases

**Reference:** See "Cliche Phrases" section in {antipatternsReference} for patterns, examples, and storage format

**Procedure:** Scan for time-worn metaphors, overused idioms, generic descriptions; extract examples; provide fresh alternatives

**Storage Format:** Use template from reference

**Minimum:** 3 cliches (or note "few cliches detected - original language used")
...
**Cliche Phrases ({count} detected):**
{For each cliche: original → alternative}
