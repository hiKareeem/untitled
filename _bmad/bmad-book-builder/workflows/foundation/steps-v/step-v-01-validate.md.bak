...
Which chapter plan would you like to validate?"
...
"**Validation in progress: [story_title]** 📋

I will analyze your plan using 5 criteria:
...
"**Validation Report: [story_title]** 📊

**Overall Score: [X]/10** [star rating]
...
**Verdict:**
[READY TO WRITE / MINOR ADJUSTMENTS RECOMMENDED / REVISION REQUIRED]"
...
Display: **Validation complete - Select an option:**
- **[D]** View the detailed report
- **[E]** Switch to Edit mode to fix issues
- **[T]** Finish
...
Your validation report is saved to:
