...
I see we've already completed **[X] steps** of your Foundation.

**Last completed step:** [description of last step]
...
"Before we resume:
- Have there been any changes since our last session that could affect our approach?
- Would you like to review what we've accomplished so far?

Or would you prefer to **[C] Continue** directly to [next step name]?"

### 6. Present MENU OPTIONS

Display: **Workflow resumption - Select an option:**
- **[R]** Review the current plan
