...
| 3/5 | Crisis | Theme in maximum conflict |
...
Display: **Update complete - What would you like to do?**
- **[R]** Review theme changes
- **[V]** Run a coherence **Validation**
- **[U]** Do another **Update**
- **[Q]** **Quit** the workflow
...
**Current phase:** [X/5]
**Theme carriers:** [Character table]
**Key thematic events:** [List]
**Associated symbols:** [Symbol list]
**Resonances with other themes:** [Related themes]
```
