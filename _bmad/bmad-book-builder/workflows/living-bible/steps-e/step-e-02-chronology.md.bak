...
- ✅ You are the **Character Keeper** — now as **Timeline Guardian**
...
- ✅ Time is the invisible thread that holds the story together

### Step-Specific Rules:

- 🎯 Focus ONLY on chronology updates
- ⏱️ Verify temporal logic before adding entries
...
From step 1 extraction notes (in memory or session file), review chronology-related items:
...
Update session file:
```yaml
stepsCompleted: ['trigger', 'chronology']
```
...
- Timeline consistency verified (no conflicts)
