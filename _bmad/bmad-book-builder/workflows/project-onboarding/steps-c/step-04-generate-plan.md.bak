...
**Plan contents:**
- Executive summary
- Detected content ({chapters} chapters, {characters} characters)
...
Type [C] to continue to plan review.
```

### 6. Present MENU OPTIONS

Display: "**Select:** [P] Party Mode — Debate the plan with multiple perspectives **[C]** Continue to review"
