...
"**Updating tracking files - Chapter {chapterNumber}**

✅ Analysis validated by the user
📝 Starting updates..."
...
"✅ themes.md updated
   - [N] themes with new entries
   - [N] new character-theme connections"

### 3. Update emotions.md

"**Updating emotions.md...**"
...
"✅ emotions.md updated
   - [N] characters with new beats
   - [N] trajectories updated"

### 4. Create/Update Chapter Analysis File

"**Creating chapter-{chapterNumber}-themes.md...**"
...
"✅ chapter-{chapterNumber}-themes.md created/updated"
...
| File | Action | Details |
|------|--------|---------|
| themes.md | Updated | [N] themes, [N] entries added |
| emotions.md | Updated | [N] characters, [N] beats added |
| chapter-{chapterNumber}-themes.md | Created/Updated | Complete analysis |

**Data persisted successfully.**

Proceeding to coherence verification..."

### 6. Present MENU OPTIONS

Display: "**Select:** [C] Continue to verification"
