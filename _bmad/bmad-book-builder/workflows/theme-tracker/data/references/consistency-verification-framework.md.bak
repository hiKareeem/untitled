...
#### 🔴 Critical Issues (Issues to address)

**Definition:** Issues that likely need addressing

**Examples:**
- Theme abandoned: Active theme disappears without resolution
- Character position unchanged: Character static for 5+ chapters
- Inconsistency with previous chapters: Contradictions in tracking
- Inconsistent arc: Character behavior violates established arc
...
**Examples:**
- Theme mentioned but not explored: Theme referenced but not developed
...
- **Thematic continuity:** [OK / Number of themes with issues]
- **Emotional arcs:** [OK / Number of characters with issues]
- **Character-theme connections:** [OK / Number of connection issues]
```
...
**Verification:**
- Emotional arc: Distrust → Hesitation → Choice → Vulnerability
