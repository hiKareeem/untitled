...
"**We are at the heart of the character.** 🧠
...
"**🎯 THIS IS CRUCIAL — contradictions are what make characters human.**

**REQUIREMENT: MINIMUM 5 CONTRADICTIONS PER CHARACTER**
...
Update the **Personality** and **Desires and fears** sections in `{outputFile}`:
...
- Personality and Desires and fears sections fully populated
