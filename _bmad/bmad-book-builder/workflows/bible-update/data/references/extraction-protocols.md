...
**Scope:** All 5 bible dimensions (chronology, characters, locations, objects, themes)
...
|-------|-------------|----------|
| **Day in story** | Day number or timeline marker | "Day 3", "2 weeks later", "Three days later" |
| **Narrative vs chronological order** | Narrative structure | Linear, flashback (analepse), mixed timeline |
| **Chapter duration** | Time span covered | "2 hours", "3 days", "One week" |
| **Key events** | Major timeline events | Battles, meetings, discoveries, deaths |
...
## Dimension 2: Characters (Characters)

### What to Extract Per Character

| Field | Description | Notes |
|-------|-------------|-------|
| **Presence** | Who appears in chapter | List all characters |
| **Actions** | What they do | Major actions and dialogue |
| **Psychological state** | Mental/emotional state | Especially important for POV characters |
| **POV** | Viewpoint status | Is this character a POV for chapter/scenes? |
| **Changes** | Character development | Decisions, transformations, growth |
...
- ✅ Character state aligns with last known state in `characters.md`
- ✅ Character locations consistent with chronology and locations
...
## Dimension 3: Locations (Locations)

### What to Extract Per Location

| Field | Description | Examples |
|-------|-------------|----------|
| **Location name** | Location name | "Paris", "The kitchen", "Bourbon Castle" |
| **Description** | Physical details | New information only if different from existing |
| **Events** | What happens here | Plot events, battles, conversations |
| **Resources** | Resources used/available | Weapons, food, magical items, shelter |
| **First mention** | New location check | Use Grep to search entire bible |

### Validation Checks

- ✅ Location description matches existing `locations.md`
...
## Dimension 4: Objects (Objects)

### What to Extract Per Object

| Field | Description | Examples |
|-------|-------------|----------|
| **Object name** | Object name | "Excalibur", "The ring", "Secret documents" |
| **Status** | Current state | Created, destroyed, lost, found, used |
| **Changes** | Status changes | How state changed from last known |
| **Significance** | Plot/symbolic importance | Why this object matters to story |
| **First mention** | New object check | Use Grep to search entire bible |

### Validation Checks

- ✅ Object status matches last known state in `objects.md`
...
| Field | Description | Examples |
|-------|-------------|----------|
| **Advanced themes** | Existing themes progressing | How theme moves forward in this chapter |
| **New themes** | Emerging themes | New thematic elements not previously tracked |
| **Thematic connections** | Links to other elements | How themes connect to character arcs, plot events |
...
| Event contradiction | Timeline event contradicts chronology.md sequence |
...
|-------|------------|------------------|
| Time-Character | Chronology ↔ Characters | Characters in right place at right time |
| Character-Location | Characters ↔ Locations | Character movements plausible |
| Character-Theme | Characters ↔ Themes | Actions align with arcs |
| Object-Time | Objects ↔ Chronology | Object timeline consistency |
...
### Chronology
- Day: {day number or marker}
- Order: {linear / flashback / mixed}
- Duration: {time span}
- Events:
  - {event 1}
  - {event 2}
