...
|-----------|---------------------|
| **Chronology** | Day, timeline order, duration, key events |
| **Characters** | Presence, actions, psychological state, POV, changes, relations |
| **Locations** | Name, description, events, resources |
| **Objects** | Name, status, changes, significance |
| **Themes** | Progression, new themes, connections |
...
- Characters ↔ Themes: Actions align with arcs?
...
**Structure includes:** Chronology, Characters present, Significant absences, Locations used, Notable objects, Themes advanced, Inconsistencies detected, Uncertain extractions
