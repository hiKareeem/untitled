...
| **personnes.md** | Append entries per character | "First appearance" |
| **lieux.md** | Append usage records per location | "First mention" |
| **objets.md** | Append status updates per object | "First mention" |
| **themes.md** | Append progression notes per theme | "Emergence" |
...
- Validation results (inconsistencies, uncertain extractions)
- Applied resolutions
...
**First Mentions:**
- Always mark "First mention/appearance: Chapter {XX}"
