...
**Appearances:**
- Last Appearance: B2 Ch 38 — "Circulation" (Cathedral of Living Sound, saturation event, *circulation* spoken aloud)
- Next Planned Appearance: Phase 5 — Ch 47 "She Did Not Follow" (dozens of Threshold volunteers walk toward the Anchor; Nephthys watches, does not follow)
...
**Current Psychological State:**
- Phase: 4/5 Book 2 (Past Witness — expression Nephthys cannot name, Imani cannot either)
- Emotional State: Past witness. The measuring look completed its shift to witness at the perimeter (Ch 35). Ch 38 moves past that: the prophet fell on the Cathedral floor, seized for twelve seconds, and the expression that remained after the measurement and the witnessing and the clinical assessment had all been applied and found insufficient is something neither woman has a name for. The acolyte who followed Nephthys into exile has become the only witness to what the prophet is becoming — and what the prophet is becoming has exceeded the available categories.
- Dominant Beliefs: Follows Nephthys the person, not the theology. The only one who can name what Nephthys cannot say to herself — and now the only one who receives what Nephthys cannot yet theologize. "Those are assertions." / "What do you hear?"
- Internal Contradictions: The practical labor that sustains the prophet has become the labor of witnessing the prophet exceed her own framework. Imani builds the scaffolding. The scaffolding is now holding something neither of them designed.
