...
**Appearances:**
- Last Appearance: B3 Ch 5 ("Voluntary")
...
- Next Planned Appearance: B3 Ch 15, Ch 23, Ch 33, Ch 40, Ch 45
...
- **B3 Ch 5:** Vladivostok, Zone 7-North breach perimeter. Six months post-Broadcast, six months post-tribunal. Civilian clothes (grey jacket, no rank insignia, no unit patch). Perimeter unchanged in fifteen years (same ground, same infrastructure, FAS-standard barrier now). Containment team: hybrid doctrine (PCC kinetic + FAS acoustic dampening), no briefing authorized it. NCO recognizes him from honest report photograph: "You are Volkov." / "I was." NCO reports: "We adjusted. Propagation response improved fourteen percent." Honest reports leaked into operational practice through unofficial channels. Aggregate vocalization continuous since Broadcast — not names, not individual voices. Aggregate output. Six months listening (Lagos, transit, Vladivostok). Jarek not heard. "The person was in there. The person was not separable from the population." Jaw compression: 1mm (Jarek's absence). Voluntary walker at 14:22 — mid-thirties, dark coat, walked into shimmer. Nikolai watched, did not intervene. "He was done intervening." Monitoring station logged "civilian transit, voluntary, one-way." Institutional vocabulary vs. observed reality: "accepted." Field log opened 15:07 (sixty-minute window held). Longest entry shown in trilogy — seven paragraphs. Containment team, hum discrepancy (6.9 body / 7.1 instruments), voluntary absorption, Jarek's absence, Corridor callback, mother's name (Vladivostok 2161), closing thesis. "No elaboration required. The observation is the elaboration." Hands-check: still (2 deployments). Closing: "Because he chose to." First voluntary act of career. Hum 6.9. Perimeter continued. Phase 1 B3: discharged soldier learning what voluntary means. Field log lengthening (institutional compression lifted). Witness function chosen, not ordered.
